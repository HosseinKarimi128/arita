...
<html class="">
	<head>
		...
		<meta property="og:title" content="model/modules.py · seungheondoh/LP-Music-Caps-demo at main" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="https://huggingface.co/spaces/seungheondoh/LP-Music-Caps-demo/blob/main/model/modules.py" />
		...
		<link rel="canonical" href="https://huggingface.co/spaces/seungheondoh/LP-Music-Caps-demo/blob/main/model/modules.py">  <!-- HEAD_svelte-1oal594_START --><style>.blob-line-num::before {
			content: attr(data-line-num);
		}
	</style><!-- HEAD_svelte-1oal594_END -->

		<title>model/modules.py · seungheondoh/LP-Music-Caps-demo at main</title>
	...
	<button class="px-2 py-0.5 hover:text-gray-500 dark:hover:text-gray-600 flex items-center " type="button">
		...
		<li><form action="/logout" method="POST" class="hidden"><input type="hidden" name="csrf" value="eyJkYXRhIjp7ImV4cGlyYXRpb24iOjE3MzA4Nzg1MTY0ODQsInVzZXJJZCI6IjY2YjIxYTA4ZGYxZTUzODMxZTAwYmVkMyJ9LCJzaWduYXR1cmUiOiJiNTg2Y2M0MDNhMDQ3OTQ0N2QyYTljYjFjMjYyZjRmN2ZhODQ1MmFjMjhjNjg3MDRhYzA0ZDc4NDcxOWNmZTNhIn0="></form>
...
<button class="text-xs" type="button" title="Toggle Line Wrap"><svg class="opacity-50" width="1em" height="1em" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.75 1.25H11.25M0.75 5H9C9.75 5 11.25 5.375 11.25 6.875C11.25 8.375 9.99975 8.75 9.375 8.75H6M6 8.75L7.5 7.25M6 8.75L7.5 10.25M0.75 8.75H3.75" stroke="currentColor" stroke-width="1.125" stroke-linecap="round" stroke-linejoin="round"></path></svg></button></div>
			...
			<div class="relative min-h-[100px] rounded-b-lg border border-t-0 leading-tight dark:border-gray-800 dark:bg-gray-925">
				<div class="py-3"><div class="SVELTE_HYDRATER contents" data-target="BlobContent" data-props="{&quot;lines&quot;:[&quot;<span class=\&quot;hljs-comment\&quot;>### code reference: https://github.com/openai/whisper/blob/main/whisper/audio.py</span>&quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> os&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> torch&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> torchaudio&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> numpy <span class=\&quot;hljs-keyword\&quot;>as</span> np&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> torch.nn.functional <span class=\&quot;hljs-keyword\&quot;>as</span> F&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>from</span> torch <span class=\&quot;hljs-keyword\&quot;>import</span> Tensor, nn&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>from</span> typing <span class=\&quot;hljs-keyword\&quot;>import</span> <span class=\&quot;hljs-type\&quot;>Dict</span>, Iterable, <span class=\&quot;hljs-type\&quot;>Optional</span>&quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-comment\&quot;># hard-coded audio hyperparameters</span>&quot;,&quot;SAMPLE_RATE = <span class=\&quot;hljs-number\&quot;>16000</span>&quot;,&quot;N_FFT = <span class=\&quot;hljs-number\&quot;>1024</span>&quot;,&quot;N_MELS = <span class=\&quot;hljs-number\&quot;>128</span>&quot;,&quot;HOP_LENGTH = <span class=\&quot;hljs-built_in\&quot;>int</span>(<span class=\&quot;hljs-number\&quot;>0.01</span> * SAMPLE_RATE)&quot;,&quot;DURATION = <span class=\&quot;hljs-number\&quot;>10</span>&quot;,&quot;N_SAMPLES = <span class=\&quot;hljs-built_in\&quot;>int</span>(DURATION * SAMPLE_RATE) &quot;,&quot;N_FRAMES = N_SAMPLES // HOP_LENGTH + <span class=\&quot;hljs-number\&quot;>1</span> &quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>def</span> <span class=\&quot;hljs-title function_\&quot;>sinusoids</span>(<span class=\&quot;hljs-params\&quot;>length, channels, max_timescale=<span class=\&quot;hljs-number\&quot;>10000</span></span>):&quot;,&quot;    <span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;Returns sinusoids for positional embedding&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;    log_timescale_increment = np.log(max_timescale) / (channels // <span class=\&quot;hljs-number\&quot;>2</span> - <span class=\&quot;hljs-number\&quot;>1</span>)&quot;,&quot;    inv_timescales = torch.exp(-log_timescale_increment * torch.arange(channels // <span class=\&quot;hljs-number\&quot;>2</span>))&quot;,&quot;    scaled_time = torch.arange(length)[:, np.newaxis] * inv_timescales[np.newaxis, :]&quot;,&quot;    <span class=\&quot;hljs-keyword\&quot;>return</span> torch.cat([torch.sin(scaled_time), torch.cos(scaled_time)], dim=<span class=\&quot;hljs-number\&quot;>1</span>)&quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>class</span> <span class=\&quot;hljs-title class_\&quot;>MelEncoder</span>(nn.Module):&quot;,&quot;    <span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>    time-frequency represntation</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>    &amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;    <span class=\&quot;hljs-keyword\&quot;>def</span> <span class=\&quot;hljs-title function_\&quot;>__init__</span>(<span class=\&quot;hljs-params\&quot;>self, </span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                sample_rate= <span class=\&quot;hljs-number\&quot;>16000</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                f_min=<span class=\&quot;hljs-number\&quot;>0</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                f_max=<span class=\&quot;hljs-number\&quot;>8000</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                n_fft=<span class=\&quot;hljs-number\&quot;>1024</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                win_length=<span class=\&quot;hljs-number\&quot;>1024</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                hop_length = <span class=\&quot;hljs-built_in\&quot;>int</span>(<span class=\&quot;hljs-params\&quot;><span class=\&quot;hljs-number\&quot;>0.01</span> * <span class=\&quot;hljs-number\&quot;>16000</span></span>),</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                n_mels = <span class=\&quot;hljs-number\&quot;>128</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                power = <span class=\&quot;hljs-literal\&quot;>None</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                pad= <span class=\&quot;hljs-number\&quot;>0</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                normalized= <span class=\&quot;hljs-literal\&quot;>False</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                center= <span class=\&quot;hljs-literal\&quot;>True</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                pad_mode= <span class=\&quot;hljs-string\&quot;>&amp;quot;reflect&amp;quot;</span></span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>                </span>):&quot;,&quot;        <span class=\&quot;hljs-built_in\&quot;>super</span>(MelEncoder, self).__init__()&quot;,&quot;        self.window = torch.hann_window(win_length)&quot;,&quot;        self.spec_fn = torchaudio.transforms.Spectrogram(&quot;,&quot;            n_fft = n_fft,&quot;,&quot;            win_length = win_length,&quot;,&quot;            hop_length = hop_length,&quot;,&quot;            power = power&quot;,&quot;        )&quot;,&quot;        self.mel_scale = torchaudio.transforms.MelScale(&quot;,&quot;            n_mels, &quot;,&quot;            sample_rate,&quot;,&quot;            f_min,&quot;,&quot;            f_max,&quot;,&quot;            n_fft // <span class=\&quot;hljs-number\&quot;>2</span> + <span class=\&quot;hljs-number\&quot;>1</span>)&quot;,&quot;        &quot;,&quot;        self.amplitude_to_db = torchaudio.transforms.AmplitudeToDB()&quot;,&quot;&quot;,&quot;    <span class=\&quot;hljs-keyword\&quot;>def</span> <span class=\&quot;hljs-title function_\&quot;>forward</span>(<span class=\&quot;hljs-params\&quot;>self, wav</span>):&quot;,&quot;        spec = self.spec_fn(wav)&quot;,&quot;        power_spec = spec.real.<span class=\&quot;hljs-built_in\&quot;>abs</span>().<span class=\&quot;hljs-built_in\&quot;>pow</span>(<span class=\&quot;hljs-number\&quot;>2</span>)&quot;,&quot;        mel_spec = self.mel_scale(power_spec)&quot;,&quot;        mel_spec = self.amplitude_to_db(mel_spec) <span class=\&quot;hljs-comment\&quot;># Log10(max(reference value and amin))</span>&quot;,&quot;        <span class=\&quot;hljs-keyword\&quot;>return</span> mel_spec&quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>class</span> <span class=\&quot;hljs-title class_\&quot;>AudioEncoder</span>(nn.Module):&quot;,&quot;    <span class=\&quot;hljs-keyword\&quot;>def</span> <span class=\&quot;hljs-title function_\&quot;>__init__</span>(<span class=\&quot;hljs-params\&quot;></span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>        self, n_mels: <span class=\&quot;hljs-built_in\&quot;>int</span>, n_ctx: <span class=\&quot;hljs-built_in\&quot;>int</span>, audio_dim: <span class=\&quot;hljs-built_in\&quot;>int</span>, text_dim: <span class=\&quot;hljs-built_in\&quot;>int</span>, num_of_stride_conv: <span class=\&quot;hljs-built_in\&quot;>int</span>,</span>&quot;,&quot;<span class=\&quot;hljs-params\&quot;>    </span>):&quot;,&quot;        <span class=\&quot;hljs-built_in\&quot;>super</span>().__init__()&quot;,&quot;        self.mel_encoder = MelEncoder(n_mels=n_mels)&quot;,&quot;        self.conv1 = nn.Conv1d(n_mels, audio_dim, kernel_size=<span class=\&quot;hljs-number\&quot;>3</span>, padding=<span class=\&quot;hljs-number\&quot;>1</span>)&quot;,&quot;        self.conv_stack = nn.ModuleList([])&quot;,&quot;        <span class=\&quot;hljs-keyword\&quot;>for</span> _ <span class=\&quot;hljs-keyword\&quot;>in</span> <span class=\&quot;hljs-built_in\&quot;>range</span>(num_of_stride_conv):&quot;,&quot;            self.conv_stack.append(&quot;,&quot;                nn.Conv1d(audio_dim, audio_dim, kernel_size=<span class=\&quot;hljs-number\&quot;>3</span>, stride=<span class=\&quot;hljs-number\&quot;>2</span>, padding=<span class=\&quot;hljs-number\&quot;>1</span>)&quot;,&quot;            )&quot;,&quot;        <span class=\&quot;hljs-comment\&quot;># self.proj = nn.Linear(audio_dim, text_dim, bias=False)</span>&quot;,&quot;        self.register_buffer(<span class=\&quot;hljs-string\&quot;>&amp;quot;positional_embedding&amp;quot;</span>, sinusoids(n_ctx, text_dim))&quot;,&quot;&quot;,&quot;    <span class=\&quot;hljs-keyword\&quot;>def</span> <span class=\&quot;hljs-title function_\&quot;>forward</span>(<span class=\&quot;hljs-params\&quot;>self, x: Tensor</span>):&quot;,&quot;        <span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>        x : torch.Tensor, shape = (batch_size, waveform)</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>            single channel wavform</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>        &amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;        x = self.mel_encoder(x) <span class=\&quot;hljs-comment\&quot;># (batch_size, n_mels, n_ctx)</span>&quot;,&quot;        x = F.gelu(self.conv1(x))&quot;,&quot;        <span class=\&quot;hljs-keyword\&quot;>for</span> conv <span class=\&quot;hljs-keyword\&quot;>in</span> self.conv_stack:&quot;,&quot;            x = F.gelu(conv(x))&quot;,&quot;        x = x.permute(<span class=\&quot;hljs-number\&quot;>0</span>, <span class=\&quot;hljs-number\&quot;>2</span>, <span class=\&quot;hljs-number\&quot;>1</span>)&quot;,&quot;        x = (x + self.positional_embedding).to(x.dtype)&quot;,&quot;        <span class=\&quot;hljs-keyword\&quot;>return</span> x&quot;],&quot;lineSelectorClass&quot;:&quot;blob-line&quot;,&quot;context&quot;:{&quot;repo&quot;:{&quot;name&quot;:&quot;seungheondoh/LP-Music-Caps-demo&quot;,&quot;type&quot;:&quot;space&quot;},&quot;revision&quot;:&quot;83027ae8b0806281fa539ebf43f69b016265bcee&quot;,&quot;path&quot;:&quot;model/modules.py&quot;}}">
...
<div class="relative text-sm"><div class="overflow-x-auto"><table class="min-w-full border-collapse font-mono"><tbody><tr class="" id="L1">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-comment">### code reference: https://github.com/openai/whisper/blob/main/whisper/audio.py</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L2">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">import</span> torchaudio<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L6">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">from</span> torch <span class="hljs-keyword">import</span> Tensor, nn<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L9">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">from</span> typing <span class="hljs-keyword">import</span> <span class="hljs-type">Dict</span>, Iterable, <span class="hljs-type">Optional</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L10">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-comment"># hard-coded audio hyperparameters</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L12">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->SAMPLE_RATE = <span class="hljs-number">16000</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L13">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->N_FFT = <span class="hljs-number">1024</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L14">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->N_MELS = <span class="hljs-number">128</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L15">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->HOP_LENGTH = <span class="hljs-built_in">int</span>(<span class="hljs-number">0.01</span> * SAMPLE_RATE)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L16">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->DURATION = <span class="hljs-number">10</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L17">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->N_SAMPLES = <span class="hljs-built_in">int</span>(DURATION * SAMPLE_RATE) <!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L18">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->N_FRAMES = N_SAMPLES // HOP_LENGTH + <span class="hljs-number">1</span> <!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L19">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">def</span> <span class="hljs-title function_">sinusoids</span>(<span class="hljs-params">length, channels, max_timescale=<span class="hljs-number">10000</span></span>):<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L21">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    <span class="hljs-string">&quot;&quot;&quot;Returns sinusoids for positional embedding&quot;&quot;&quot;</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L22">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    log_timescale_increment = np.log(max_timescale) / (channels // <span class="hljs-number">2</span> - <span class="hljs-number">1</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L23">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    inv_timescales = torch.exp(-log_timescale_increment * torch.arange(channels // <span class="hljs-number">2</span>))<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L24">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    scaled_time = torch.arange(length)[:, np.newaxis] * inv_timescales[np.newaxis, :]<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L25">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    <span class="hljs-keyword">return</span> torch.cat([torch.sin(scaled_time), torch.cos(scaled_time)], dim=<span class="hljs-number">1</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L26">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">class</span> <span class="hljs-title class_">MelEncoder</span>(nn.Module):<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L28">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">    time-frequency represntation</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L30">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    <span class="hljs-keyword">def</span> <span class="hljs-title function_">__init__</span>(<span class="hljs-params">self, </span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L32">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                sample_rate= <span class="hljs-number">16000</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L33">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                f_min=<span class="hljs-number">0</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L34">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                f_max=<span class="hljs-number">8000</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L35">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                n_fft=<span class="hljs-number">1024</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L36">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                win_length=<span class="hljs-number">1024</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L37">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                hop_length = <span class="hljs-built_in">int</span>(<span class="hljs-params"><span class="hljs-number">0.01</span> * <span class="hljs-number">16000</span></span>),</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L38">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                n_mels = <span class="hljs-number">128</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L39">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                power = <span class="hljs-literal">None</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L40">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                pad= <span class="hljs-number">0</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L41">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                normalized= <span class="hljs-literal">False</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L42">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                center= <span class="hljs-literal">True</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L43">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">                pad_mode= <span class="hljs-string">&quot;reflect&quot;</span></span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L44">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        <span class="hljs-built_in">super</span>(MelEncoder, self).__init__()<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L46">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.window = torch.hann_window(win_length)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L47">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.spec_fn = torchaudio.transforms.Spectrogram(<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L48">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            n_fft = n_fft,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L49">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            win_length = win_length,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L50">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            hop_length = hop_length,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L51">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            power = power<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L52">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.mel_scale = torchaudio.transforms.MelScale(<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L54">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            n_mels, <!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L55">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            sample_rate,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L56">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            f_min,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L57">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            f_max,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L58">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            n_fft // <span class="hljs-number">2</span> + <span class="hljs-number">1</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L59">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.amplitude_to_db = torchaudio.transforms.AmplitudeToDB()<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L61">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, wav</span>):<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L63">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        spec = self.spec_fn(wav)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L64">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        power_spec = spec.real.<span class="hljs-built_in">abs</span>().<span class="hljs-built_in">pow</span>(<span class="hljs-number">2</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L65">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        mel_spec = self.mel_scale(power_spec)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L66">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        mel_spec = self.amplitude_to_db(mel_spec) <span class="hljs-comment"># Log10(max(reference value and amin))</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L67">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        <span class="hljs-keyword">return</span> mel_spec<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L68">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">class</span> <span class="hljs-title class_">AudioEncoder</span>(nn.Module):<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L70">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-params">        self, n_mels: <span class="hljs-built_in">int</span>, n_ctx: <span class="hljs-built_in">int</span>, audio_dim: <span class="hljs-built_in">int</span>, text_dim: <span class="hljs-built_in">int</span>, num_of_stride_conv: <span class="hljs-built_in">int</span>,</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L72">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.mel_encoder = MelEncoder(n_mels=n_mels)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L75">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.conv1 = nn.Conv1d(n_mels, audio_dim, kernel_size=<span class="hljs-number">3</span>, padding=<span class="hljs-number">1</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L76">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.conv_stack = nn.ModuleList([])<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L77">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        <span class="hljs-keyword">for</span> _ <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(num_of_stride_conv):<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L78">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            self.conv_stack.append(<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L79">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->                nn.Conv1d(audio_dim, audio_dim, kernel_size=<span class="hljs-number">3</span>, stride=<span class="hljs-number">2</span>, padding=<span class="hljs-number">1</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L80">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        <span class="hljs-comment"># self.proj = nn.Linear(audio_dim, text_dim, bias=False)</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L82">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        self.register_buffer(<span class="hljs-string">&quot;positional_embedding&quot;</span>, sinusoids(n_ctx, text_dim))<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L83">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, x: Tensor</span>):<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L85">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">        x : torch.Tensor, shape = (batch_size, waveform)</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L87">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">            single channel wavform</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L88">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        x = self.mel_encoder(x) <span class="hljs-comment"># (batch_size, n_mels, n_ctx)</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L90">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        x = F.gelu(self.conv1(x))<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L91">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        <span class="hljs-keyword">for</span> conv <span class="hljs-keyword">in</span> self.conv_stack:<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L92">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->            x = F.gelu(conv(x))<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L93">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        x = x.permute(<span class="hljs-number">0</span>, <span class="hljs-number">2</span>, <span class="hljs-number">1</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L94">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        x = (x + self.positional_embedding).to(x.dtype)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L95">
						...
						<td class="blob-line overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->        <span class="hljs-keyword">return</span> x<!-- HTML_TAG_END --></td>
					</tr></tbody></table></div>
